...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Sau Vị Đắng — Hành trình của một ly cà phê" },
      { property: "og:description", content: "Kinh tế Chính trị Mác–Lênin qua hành trình của một ly cà phê Việt." },
